...
public class FullIndexTwoWord extends Configured implements Tool {

	private static final Logger LOG = Logger.getLogger(Index.class);

	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new FullIndexTwoWord(), args);
		System.exit(res);
	}
...
/////////////////////////////////////////////////
////************* full position index for phrase 
////////////////////////////////////////
////mapper class beaking each word and converting it to word and (offset,docId) as key value pair and
/// creating biword as index (two adjacent words) and (offset,docId) as key value pair
	// which stored on local and later used by reducer.Each posting is sorted
	// internally
